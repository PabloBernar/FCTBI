...
from PyQt5.QtWidgets import (
    ...
    QTextEdit, QDialog, QCheckBox, QSpinBox, QFormLayout, QGroupBox,
...
# Importação do easter egg da Bianca
...
class HelpDialog(QDialog):
    def __init__(self, parent=None):
        ...
        text_edit.setHtml("""
            <h1>Manual do Usuário - FCTBI v2.0</h1>
            ...
            <p><b>Oferecimento facilittec.com.br<br>de Pablo p/Bianca s2.</b></p>
        """)
        close_btn = QPushButton("Fechar")
        close_btn.clicked.connect(self.close)
...
class RespostaRapidaApp(QMainWindow, FaderWidget):
    ...
    def setup_ui(self):
        self.setWindowTitle('FCTBI - Respostas Rápidas v2.0')
    ...
    def add_section(self):
        ...
        if ok and name:
            # Verifica se é o easter egg da Bianca ANTES de criar a seção
